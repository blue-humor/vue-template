...
function createTranslate(name95) {
  const prefix = camelize(name95) + ".";
  return (path, ...args) => {
...
function genBem(name95, mods) {
  ...
  if (Array.isArray(mods)) {
    return mods.reduce((ret, item) => ret + genBem(name95, item), "");
  }
  return Object.keys(mods).reduce((ret, key) => ret + (mods[key] ? genBem(name95, key) : ""), "");
}
function createBEM(name95) {
  return (el, mods) => {
    if (el && typeof el !== "string") {
      mods = el;
      el = "";
    }
    el = el ? `${name95}__${el}` : name95;
    return `${el}${genBem(el, mods)}`;
  };
}
function createNamespace(name95) {
  const prefixedName = `van-${name95}`;
  return [
    prefixedName,
...
function withInstall(options) {
  options.install = (app) => {
    const { name: name95 } = options;
    app.component(name95, options);
    app.component(camelize(`-${name95}`), options);
  };
  return options;
}
...
var stdin_default17 = defineComponent({
  ...
  setup(props, {
    ...
    const renderValue = () => {
      ...
      if (hasValue) {
        return createVNode("div", {
          "class": [bem15("value"), props.valueClass]
...
function useId() {
  ...
  const { name: name95 = "unknown" } = (vm == null ? void 0 : vm.type) || {};
  if (false) {
    return name95;
  }
  return `${name95}-${++current}`;
}
...
var Toast = withInstall(stdin_default20);
...
var stdin_default26 = defineComponent({
  ...
  setup(props, {
    ...
    const iconRef = ref();
    const getParentProp = (name95) => {
      if (props.parent && props.bindGroup) {
        return props.parent.props[name95];
      }
    };
...
var stdin_default40 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      }) : [renderHeader(), (_a = slots["nav-bottom"]) == null ? void 0 : _a.call(slots)], createVNode(stdin_default39, {
...
var DatePicker = withInstall(stdin_default60);

// node_modules/vant/es/dialog/Dialog.mjs
var [name58, bem54, t13] = createNamespace("dialog");
...
function initInstance() {
  const Wrapper = {
    setup() {
      ...
      return () => createVNode(stdin_default61, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  };
...
var Dialog = withInstall(stdin_default61);

// node_modules/vant/es/divider/Divider.mjs
var [name59, bem55] = createNamespace("divider");
var dividerProps = {
  dashed: Boolean,
  hairline: truthProp,
...
var Divider = withInstall(stdin_default62);

// node_modules/vant/es/dropdown-menu/DropdownMenu.mjs
var [name60, bem56] = createNamespace("dropdown-menu");
...
var DROPDOWN_KEY = Symbol(name60);
...
var [name61, bem57] = createNamespace("dropdown-item");
...
var DropdownItem = withInstall(stdin_default64);

// node_modules/vant/es/dropdown-menu/index.mjs
var DropdownMenu = withInstall(stdin_default63);

// node_modules/vant/es/grid/Grid.mjs
var [name62, bem58] = createNamespace("grid");
var gridProps = {
  square: Boolean,
  center: truthProp,
  border: truthProp,
...
var Grid = withInstall(stdin_default65);

// node_modules/vant/es/grid-item/GridItem.mjs
var [name63, bem59] = createNamespace("grid-item");
...
var stdin_default66 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const classes = [bem59("content", [direction, {
        center,
        square,
        reverse,
        clickable,
...
var GridItem = withInstall(stdin_default66);
...
var bem60 = createNamespace("image-preview")[1];
...
var [name64, bem61] = createNamespace("image-preview");
...
var stdin_default68 = defineComponent({
  ...
  setup(props, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props.images.map((image) => createVNode(stdin_default67, {
        "src": image,
        "show": props.show,
        "active": state.active,
    ...
    const renderClose = () => {
      if (props.closeable) {
        return createVNode(Icon, {
          "role": "button",
          "name": props.closeIcon,
          "class": [bem61("close-icon", props.closeIconPosition), HAPTICS_FEEDBACK],
          "onClick": emitClose
        }, null);
      }
    };
    ...
    return () => createVNode(Popup, mergeProps({
      "class": [bem61(), props.className],
      "overlayClass": [bem61("overlay"), props.overlayClass],
      "onClosed": onClosed,
      "onUpdate:show": updateShow
...
function initInstance2() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default68, mergeProps(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
var ImagePreview = withInstall(stdin_default68);
...
var [name65, bem62] = createNamespace("index-bar");
var indexBarProps = {
  sticky: truthProp,
  zIndex: numericProp,
  teleport: [String, Object],
...
var INDEX_BAR_KEY = Symbol(name65);
...
var [name66, bem63] = createNamespace("index-anchor");
...
var IndexAnchor = withInstall(stdin_default70);

// node_modules/vant/es/index-bar/index.mjs
var IndexBar = withInstall(stdin_default69);

// node_modules/vant/es/list/List.mjs
var [name67, bem64, t14] = createNamespace("list");
var listProps = {
  error: Boolean,
...
var List = withInstall(stdin_default71);

// node_modules/vant/es/nav-bar/NavBar.mjs
var [name68, bem65] = createNamespace("nav-bar");
var navBarProps = {
  title: String,
  fixed: Boolean,
  zIndex: numericProp,
...
var stdin_default72 = defineComponent({
  ...
  setup(props, {
    ...
    const navBarRef = ref();
    const renderPlaceholder = usePlaceholder(navBarRef, bem65);
    ...
    const renderNavBar = () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem65("left"), HAPTICS_FEEDBACK],
        "onClick": onClickLeft
      }, [renderLeft()]), createVNode("div", {
        "class": [bem65("title"), "van-ellipsis"]
      }, [slots.title ? slots.title() : title]), hasRight && createVNode("div", {
        "class": [bem65("right"), HAPTICS_FEEDBACK],
...
var NavBar = withInstall(stdin_default72);

// node_modules/vant/es/notice-bar/NoticeBar.mjs
var [name69, bem66] = createNamespace("notice-bar");
var noticeBarProps = {
  text: String,
  mode: String,
  color: String,
...
var NoticeBar = withInstall(stdin_default73);

// node_modules/vant/es/notify/Notify.mjs
var [name70, bem67] = createNamespace("notify");
...
var stdin_default74 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(Popup, {
      "show": props.show,
      "class": [bem67([props.type]), props.className],
      "style": {
        color: props.color,
        background: props.background
      },
...
var Notify = withInstall(stdin_default74);

// node_modules/vant/es/number-keyboard/NumberKeyboardKey.mjs
var [name71, bem68] = createNamespace("key");
var CollapseIcon = createVNode("svg", {
  "class": bem68("collapse-icon"),
  "viewBox": "0 0 30 24"
}, [createVNode("path", {
...
var [name72, bem69] = createNamespace("number-keyboard");
...
var stdin_default76 = defineComponent({
  ...
  setup(props, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default75, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props.theme === "custom") {
        return createVNode("div", {
          "class": bem69("sidebar")
        }, [props.showDeleteKey && createVNode(stdin_default75, {
          "large": true,
...
var NumberKeyboard = withInstall(stdin_default76);

// node_modules/vant/es/pagination/Pagination.mjs
var [name73, bem70, t15] = createNamespace("pagination");
...
var Pagination = withInstall(stdin_default77);

// node_modules/vant/es/password-input/PasswordInput.mjs
var [name74, bem71] = createNamespace("password-input");
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem71("security"), {
          [BORDER_SURROUND]: !props.gutter
        }],
        "onTouchstart": onTouchStart
      }, [renderPoints()]), info && createVNode("div", {
        "class": bem71(props.errorInfo ? "error-info" : "info")
      }, [info])]);
    };
  }
});
...
var PasswordInput = withInstall(stdin_default78);
  ...
  return function createPopper2(reference, popper, options) {
    ...
    var instance4 = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          var modifiers = uniqueBy([].concat(orderedModifiers, state.options.modifiers), function(_ref) {
            var name95 = _ref.name;
            return name95;
          });
          validateModifiers(modifiers);
          if (getBasePlacement(state.options.placement) === auto) {
            var flipModifier = state.orderedModifiers.find(function(_ref2) {
              var name95 = _ref2.name;
              return name95 === "flip";
            });
            if (!flipModifier) {
      ...
      forceUpdate: function forceUpdate() {
        ...
        for (var index = 0; index < state.orderedModifiers.length; index++) {
          ...
          var _state$orderedModifie = state.orderedModifiers[index], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name95 = _state$orderedModifie.name;
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function(_ref3) {
        var name95 = _ref3.name, _ref3$options = _ref3.options, options2 = _ref3$options === void 0 ? {} : _ref3$options, effect3 = _ref3.effect;
...
function popperOffsets(_ref) {
  var state = _ref.state, name95 = _ref.name;
  state.modifiersData[name95] = computeOffsets({
...
function applyStyles(_ref) {
  ...
  Object.keys(state.elements).forEach(function(name95) {
    var style = state.styles[name95] || {};
    var attributes = state.attributes[name95] || {};
    var element = state.elements[name95];
...
function effect2(_ref2) {
  ...
  return function() {
    Object.keys(state.elements).forEach(function(name95) {
      var element = state.elements[name95];
      var attributes = state.attributes[name95] || {};
      var styleProperties = Object.keys(state.styles.hasOwnProperty(name95) ? state.styles[name95] : initialStyles[name95]);
...
function offset(_ref2) {
  var state = _ref2.state, options = _ref2.options, name95 = _ref2.name;
  ...
  state.modifiersData[name95] = data;
}
var offset_default = {
  name: "offset",
  enabled: true,
...
var [name75, bem72] = createNamespace("popover");
...
var Popover = withInstall(stdin_default79);

// node_modules/vant/es/progress/Progress.mjs
var [name76, bem73] = createNamespace("progress");
var progressProps = {
  color: String,
  inactive: Boolean,
  pivotText: String,
...
var Progress = withInstall(stdin_default80);

// node_modules/vant/es/pull-refresh/PullRefresh.mjs
var [name77, bem74, t16] = createNamespace("pull-refresh");
...
var PullRefresh = withInstall(stdin_default81);

// node_modules/vant/es/rate/Rate.mjs
var [name78, bem75] = createNamespace("rate");
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": bem76("content", props.shape)
...
var Search = withInstall(stdin_default83);
...
var [name80, bem77, t18] = createNamespace("share-sheet");
...
var ShareSheet = withInstall(stdin_default84);

// node_modules/vant/es/sidebar/Sidebar.mjs
var [name81, bem78] = createNamespace("sidebar");
var SIDEBAR_KEY = Symbol(name81);
var sidebarProps = {
...
var Sidebar = withInstall(stdin_default85);

// node_modules/vant/es/sidebar-item/SidebarItem.mjs
var [name82, bem79] = createNamespace("sidebar-item");
...
var SidebarItem = withInstall(stdin_default86);

// node_modules/vant/es/skeleton/Skeleton.mjs
var [name83, bem80] = createNamespace("skeleton");
...
var stdin_default87 = defineComponent({
  ...
  setup(props, {
    ...
    const renderAvatar = () => {
      if (props.avatar) {
        return createVNode("div", {
          "class": bem80("avatar", props.avatarShape),
...
var Skeleton = withInstall(stdin_default87);

// node_modules/vant/es/slider/Slider.mjs
var [name84, bem81] = createNamespace("slider");
var sliderProps = {
  ...
  setup(props, {
    ...
    const getButtonClassName = (index) => {
      if (typeof index === "number") {
        ...
        return bem81(`button-wrapper`, position[index]);
      }
      return bem81("button-wrapper", props.reverse ? "left" : "right");
    };
...
var Slider = withInstall(stdin_default88);

// node_modules/vant/es/steps/Steps.mjs
var [name85, bem82] = createNamespace("steps");
var stepsProps = {
  active: makeNumericProp(0),
...
var [name86, bem83] = createNamespace("step");
var stdin_default90 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": [BORDER, bem83([parentProps.direction, {
          [status]: status
        }])]
      }, [createVNode("div", {
        "class": bem83("title", {
...
var Step = withInstall(stdin_default90);

// node_modules/vant/es/stepper/Stepper.mjs
var [name87, bem84] = createNamespace("stepper");
...
var Stepper = withInstall(stdin_default91);

// node_modules/vant/es/steps/index.mjs
var Steps = withInstall(stdin_default89);

// node_modules/vant/es/submit-bar/SubmitBar.mjs
var [name88, bem85, t19] = createNamespace("submit-bar");
var submitBarProps = {
  tip: String,
  label: String,
  price: Number,
...
var stdin_default92 = defineComponent({
  ...
  setup(props, {
    ...
    const root = ref();
    const renderPlaceholder = usePlaceholder(root, bem85);
    const renderText = () => {
      const {
        price,
        label,
      ...
      if (typeof price === "number") {
        ...
        return createVNode("div", {
          ...
          "class": bem85("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && createVNode("span", {
          "class": bem85("suffix-label")
        }, [suffixLabel])]);
      }
    };
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return createVNode("div", {
          ...
          "class": bem85("tip-icon"),
          "name": tipIcon
        }, null), tip && createVNode("span", {
          "class": bem85("tip-text")
    ...
    const renderButton = () => {
      ...
      return createVNode(Button, {
        ...
        "class": bem85("button", props.buttonType),
...
var SubmitBar = withInstall(stdin_default92);

// node_modules/vant/es/swipe-cell/SwipeCell.mjs
var [name89, bem86] = createNamespace("swipe-cell");
var swipeCellProps = {
  name: makeNumericProp(""),
  disabled: Boolean,
...
var SwipeCell = withInstall(stdin_default93);

// node_modules/vant/es/tabbar/Tabbar.mjs
var [name90, bem87] = createNamespace("tabbar");
var tabbarProps = {
  route: Boolean,
  fixed: truthProp,
  border: truthProp,
...
var Tabbar = withInstall(stdin_default94);

// node_modules/vant/es/tabbar-item/TabbarItem.mjs
var [name91, bem88] = createNamespace("tabbar-item");
...
var TabbarItem = withInstall(stdin_default95);

// node_modules/vant/es/time-picker/TimePicker.mjs
var [name92] = createNamespace("time-picker");
...
var TimePicker = withInstall(stdin_default96);

// node_modules/vant/es/tree-select/TreeSelect.mjs
var [name93, bem89] = createNamespace("tree-select");
var treeSelectProps = {
  max: makeNumericProp(Infinity),
  items: makeArrayProp(),
  ...
  setup(props, {
    ...
    const renderSidebar = () => {
      const Items = props.items.map((item) => createVNode(SidebarItem, {
        ...
        "title": item.text,
        "badge": item.badge,
        "class": [bem89("nav-item"), item.className],
        "disabled": item.disabled,
...
var TreeSelect = withInstall(stdin_default97);

// node_modules/vant/es/uploader/utils.mjs
var [name94, bem90, t20] = createNamespace("uploader");
  ...
  setup(props, {
    ...
    const renderDeleteIcon = () => {
      if (props.deletable && props.item.status !== "uploading") {
        ...
        return createVNode("div", {
          ...
          "name": "cross",
          "class": bem90("preview-delete-icon")
        }, null)]);
      }
    };
    const renderCover = () => {
    ...
    const renderPreview = () => {
      ...
      return createVNode("div", {
        ...
        "class": bem90("file-icon"),
        "name": "description"
      }, null), createVNode("div", {
        "class": [bem90("file-name"), "van-ellipsis"]
...
var stdin_default99 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return createVNode(stdin_default98, mergeProps({
        "item": item,
        "index": index,
    ...
    const renderUpload = () => {
      ...
      return createVNode("div", {
        ...
        "class": bem90("upload-icon")
      }, null), props.uploadText && createVNode("span", {
        "class": bem90("upload-text")
...
var Uploader = withInstall(stdin_default99);
...
var stdin_default102 = (lazyManager) => ({
  props: {
    src: [String, Object],
    tag: {
      type: String,
...
var Lazyload = {
  install(app, options = {}) {
    const LazyClass = stdin_default100();
    const lazy = new LazyClass(options);
    const lazyContainer = new LazyContainerManager({ lazy });
    app.config.globalProperties.$Lazyload = lazy;
    if (options.lazyComponent) {
      app.component("LazyComponent", stdin_default101(lazy));
    }
    if (options.lazyImage) {
      app.component("LazyImage", stdin_default102(lazy));
    }
    app.directive("lazy", {
...
export {
  ...
  version,
  install,
  stdin_default103 as stdin_default
};
//# sourceMappingURL=chunk-WELM3JP3.js.map
